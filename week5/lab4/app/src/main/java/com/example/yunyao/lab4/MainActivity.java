...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void showLoginDialog(View view) {
        ...
        if(usernameEmptyFlag){
            ...
            boolean UsernameFlag = username.getText().toString().equals(R.string.trueUsername);
            boolean PassWordFlag = password.getText().toString().equals(R.string.truePassword);
